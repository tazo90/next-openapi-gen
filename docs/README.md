...
This folder contains the longer-form guides that support the main
[README](../README.md).
...
- [Example app coverage plan](./example-app-coverage-plan.md): current example
  responsibilities plus the expansion roadmap
