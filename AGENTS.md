...
- Init docs UI templates are framework-specific under `packages/next-openapi-gen/templates/init/ui/{nextjs,tanstack,reactrouter}`, and docs-page scaffolding dispatches by framework instead of assuming Next-only output.
