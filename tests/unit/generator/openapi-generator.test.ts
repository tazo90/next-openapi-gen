    ...
    try {
      ...
      try {
        ...
        expect(performanceProfile).toMatchObject({
          ...
          deriveRoutePathMs: expect.any(Number),
          filterRouteCandidatesMs: expect.any(Number),
          sourcePrecheckMs: expect.any(Number),
          readRouteFilesMs: expect.any(Number),
          parseRouteFilesMs: expect.any(Number),
          analyzeRouteFilesMs: expect.any(Number),
          typescriptResponseInferenceMs: expect.any(Number),
          processRouteFilesMs: expect.any(Number),
          registerRouteMs: expect.any(Number),
          getSchemaContentMs: expect.any(Number),
          createRequestParamsMs: expect.any(Number),
          createRequestBodyMs: expect.any(Number),
          processResponsesMs: expect.any(Number),
          createResponseSchemaMs: expect.any(Number),
