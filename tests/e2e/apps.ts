...
const E2E_APPS: readonly E2EAppConfig[] = [
  ...
  },
  {
    ...
    docsPath: "/api-docs",
    docsText: ["API Documentation", "Download OpenAPI Document"],
    generateCommand: "pnpm --dir apps/next-app-typescript exec openapi-gen generate",
  ...
  },
  {
    ...
    docsPath: "/api-docs",
    docsText: ["API Documentation", "Download OpenAPI Document"],
    generateCommand: "pnpm --dir apps/next-app-scalar exec openapi-gen generate",
  ...
  },
  {
    ...
    generateCommand: "pnpm --dir apps/next-app-swagger exec openapi-gen generate",
  ...
  },
  {
    ...
    docsPath: "/api-docs",
    docsText: ["API Documentation", "Download OpenAPI Document"],
    generateCommand: "pnpm --dir apps/next-app-sandbox exec openapi-gen generate",
  ...
  },
  {
    ...
    generateCommand: "pnpm --dir apps/next-app-drizzle-zod exec openapi-gen generate",
  ...
  },
  {
    ...
    generateCommand: "pnpm --dir apps/next-pages-router exec openapi-gen generate",
  ...
  },
  {
    ...
    generateCommand: "pnpm --dir apps/next-app-mixed-schemas exec openapi-gen generate",
  ...
  },
  {
    ...
    generateCommand: "pnpm --dir apps/tanstack-app exec openapi-gen generate",
  ...
  },
  {
    ...
    generateCommand: "pnpm --dir apps/react-router-app exec openapi-gen generate",
  ...
  },
  {
    ...
    generateCommand: "pnpm --dir apps/next-app-ts-config exec openapi-gen generate",
