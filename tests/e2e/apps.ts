...
const E2E_APPS: readonly E2EAppConfig[] = [
  {
    ...
    generateCommand: "pnpm --dir apps/next-app-zod run generate",
  ...
  },
  {
    ...
    docsPath: "/api-docs",
    docsText: ["API Documentation", "Download OpenAPI Document"],
    generateCommand: "pnpm --dir apps/next-app-typescript run generate",
  ...
  },
  {
    ...
    docsPath: "/api-docs",
    docsText: ["API Documentation", "Download OpenAPI Document"],
    generateCommand: "pnpm --dir apps/next-app-scalar run generate",
  ...
  },
  {
    ...
    generateCommand: "pnpm --dir apps/next-app-swagger run generate",
  ...
  },
  {
    ...
    docsPath: "/api-docs",
    docsText: ["API Documentation", "Download OpenAPI Document"],
    generateCommand: "pnpm --dir apps/next-app-sandbox run generate",
  ...
  },
  {
    ...
    generateCommand: "pnpm --dir apps/next-app-drizzle-zod run generate",
  ...
  },
  {
    ...
    generateCommand: "pnpm --dir apps/next-pages-router run generate",
  ...
  },
  {
    ...
    generateCommand: "pnpm --dir apps/next-app-mixed-schemas run generate",
  ...
  },
  {
    ...
    generateCommand: "pnpm --dir apps/tanstack-app run generate",
  ...
  },
  {
    ...
    generateCommand: "pnpm --dir apps/react-router-app run generate",
  ...
  },
  {
    ...
    generateCommand: "pnpm --dir apps/next-app-ts-config run generate",
